...
function Tasks() {
    ...
    return (
        <>
            <div className='row' style={{ backgroundColor: '#ddd' }}>
                ...
                <nav className="navbar fixed navbar-dark overviewNavbar">
                    <div className='col-6 k'>
                        <Link to="/overview/projects" id='projectLink' className="navbar-brand mx-auto"><h2>Projects</h2></Link>
                    </div>
                    <div className='col-6 activeA k'>
                        <Link to="/overview/tasks" id='taskLink' className="navbar-brand mx-auto"><h2>Tasks</h2></Link>
                    </div>
                </nav>
            </div>
            <div className='row'>
                    ...
                    <div className='tasksList'>
                        {tasks.map((elem, idx) => {
                            return <div className='task' key={idx}>
                                ...
                                <h2>{elem.taskName}</h2>
                                <span className='dots' onClick={() => showOptions(elem.id)}><i className="fa fa-ellipsis-v" aria-hidden="true"></i></span>
            ...
            <div className='row'>
                <div className='col'>
                    <button type="button" className="btn btn-success btn-lg btn-block" data-toggle="modal" data-target="#exampleModal">Add New Task</button>
                </div>
            </div>
